...
- [eShop Portal](./vc-verifier-node) is capable of verifying VC thanks to the library [Sphereon SIOP-OpenID4VP](https://github.com/Sphereon-Opensource/SIOP-OpenID4VP). The library implements the standard OpenID Connect for Verifiable Presentations (OIDC4VP) and it supports requesting VC using the Presentation Exchange specs.
